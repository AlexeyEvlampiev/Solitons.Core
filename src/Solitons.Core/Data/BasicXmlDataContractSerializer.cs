...
{
    sealed class BasicXmlDataContractSerializer : DataContractSerializer
    {
        public BasicXmlDataContractSerializer(DataContractSerializerBehaviour behaviour, IEnumerable<Assembly> assemblies)
            : base(behaviour)
        {
