...
public static class HttpMessageBinaryFormatter
{
    ...
    /// <exception cref="HttpMessageSerializationException">Thrown when an error occurs during serialization and the operation was not cancelled.</exception>
    /// <remarks>
    ...
    /// <exception cref="HttpMessageSerializationException">Thrown when an error occurs during deserialization and the operation was not cancelled.</exception>
    /// <remarks>
